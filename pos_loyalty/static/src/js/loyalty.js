...
models.load_fields('res.partner','loyalty_points', 'active_points');
...
models.Order = models.Order.extend({
    ...
    export_as_JSON: function(){
        ...
        json.points_won = this.get_won_points();
        json.points_spent = this.get_spent_points();
        json.points_total = this.get_new_total_points();
        return json;
    },
});
